...
namespace FrotiX.Controllers
{
    ...
    public partial class PdfViewerCNHController : Controller
    {
        ...
        public PdfViewerCNHController(IHostingEnvironment hostingEnvironment, IMemoryCache cache, IUnitOfWork unitOfWork)
        {
