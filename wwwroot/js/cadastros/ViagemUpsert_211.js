    ...
    try
    {
        ...
        if (!kmInicialStr || !kmAtualStr)
        {
            ...
            if (!kmAtualStr || kmAtualStr === '0' || kmAtualStr === 0)
            {
                ...
                //Alerta.Erro("Erro na Quilometragem", "A quilometragem <strong>Atual</strong> deve estar preenchida e ser maior que <strong>Zero</strong>!");
            }
            return;
        }
...
$("#txtKmFinal").focusout(function ()
{
    try
    {
        ...
        if ((kmInicialStr === '' || kmInicialStr === null) && (kmFinalStr != '' && kmFinalStr != null))
        {
            $("#txtKmFinal").val('');
            $('#txtKmPercorrido').val('');
            Alerta.Erro("Erro na Quilometragem", "A quilometragem <strong>Final</strong> deve ser preenchida somente após a <strong>Inicial</strong>!");
            return;
        }
