...
/**
 * Edita um único agendamento existente.
 * Chamado de: localizar no fluxo principal (ex: btnConfirma click).
 */
...
function criarAgendamentoEdicao(agendamentoUnicoAlterado) {
    ...
    // **CORREÇÃO**: usar a dataInicial que veio no objeto, não a global
    const dataInicialFormatada = moment(agendamentoUnicoAlterado.dataInicial)
        .format('YYYY-MM-DD');
...
var accordionEvento = new ej.navigations.Accordion({
    ...
    expandMode: 'Single',
    animation: {
        expand: { effect: 'fadeIn', duration: 500 },
        collapse: { effect: 'fadeOut', duration: 500 }
    }
});
            ...
            success: async function (data) {
                try {
                    ...
                    if (data.success) {
                        ...
                        var newItem = { id: data.eventoId, name: data.eventoText };
