...
namespace FrotiX.Pages.Viagens
{
    ...
    public class PBILavagemModel : PageModel
    {
        ...
        public PBILavagemModel(IUnitOfWork unitOfWork, ILogger<IndexModel> logger, INotyfService notyf, IHostingEnvironment env, IWebHostEnvironment hostingEnvironment)
        {
