...
namespace FrotiX.Pages.Viagens
{
    ...
    public class PBITaxiLegModel : PageModel
    {
        ...
        public PBITaxiLegModel(IUnitOfWork unitOfWork, ILogger<IndexModel> logger, INotyfService notyf, IHostingEnvironment env, IWebHostEnvironment hostingEnvironment)
        {
