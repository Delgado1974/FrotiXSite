...
namespace FrotiX.Pages.Relatorio
{

    public class TesteRelatorioModel : PageModel
    {
        ...
        public TesteRelatorioModel(IUnitOfWork unitOfWork, ILogger<IndexModel> logger, INotyfService notyf, IHostingEnvironment env, IWebHostEnvironment hostingEnvironment)
        {
