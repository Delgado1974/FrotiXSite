...
namespace FrotiX.Pages.Viagens
{
    ...
    public class TaxiLegModel : PageModel
    {
        ...
        public TaxiLegModel(IUnitOfWork unitOfWork, ILogger<IndexModel> logger, INotyfService notyf, IHostingEnvironment env, IWebHostEnvironment hostingEnvironment)
        {
