...
namespace FrotiX.Pages.Viagens
{
    ...
    public class TabstripModel : PageModel
    {
        ...
        public TabstripModel(IUnitOfWork unitOfWork, ILogger<IndexModel> logger, INotyfService notyf, IHostingEnvironment env, IWebHostEnvironment hostingEnvironment)
        {
