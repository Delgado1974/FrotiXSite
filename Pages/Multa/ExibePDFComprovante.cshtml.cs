...
namespace FrotiX.Pages.Multa
{
    ...
    public class ExibePDFComprovante : PageModel
    {
        ...
        public ExibePDFComprovante(IUnitOfWork unitOfWork, INotyfService notyf, IWebHostEnvironment hostingEnvironment)
        {
