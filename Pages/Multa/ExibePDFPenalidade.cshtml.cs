...
namespace FrotiX.Pages.Multa
{
    ...
    public class ExibePDFPenalidadeModel : PageModel
    {
        ...
        public ExibePDFPenalidadeModel(IUnitOfWork unitOfWork, INotyfService notyf, IWebHostEnvironment hostingEnvironment)
        {
        ...
        public JsonResult OnGetAJAXPreencheListaEmpenhos(string id)
        {
            ...
            foreach (var empenho in ListaEmpenhos)
            {
                ...
                //empenhosList = empenhosList + "{ EmpenhoMultaId: '" + (Guid)empenho.EmpenhoMultaId + "', NotaEmpenho: '" + empenho.NotaEmpenho + "'},";

            }

            //empenhosList = "[" + empenhosList.Remove(empenhosList.Length - 1) + "]";
