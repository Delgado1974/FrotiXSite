...
namespace FrotiX.Pages.Viagens
{
    ...
    public class PBILotacaoMotoristaModel : PageModel
    {
        ...
        public PBILotacaoMotoristaModel(IUnitOfWork unitOfWork, ILogger<IndexModel> logger, INotyfService notyf, IHostingEnvironment env, IWebHostEnvironment hostingEnvironment)
        {
